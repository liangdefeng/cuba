...
public class RdbmsStore implements DataStore {
    ...
    public <E extends Entity> List<E> loadList(LoadContext<E> context) {
        if (log.isDebugEnabled())
            log.debug("loadList: metaClass=" + context.getMetaClass() + ", view=" + context.getView()
                    ...
                    + ", query=" + (context.getQuery() == null ? null : JpqlQueryBuilder.printQuery(context.getQuery().toString()))
    ...
    public List<KeyValueEntity> loadValues(ValueLoadContext context) {
        ...
        if (log.isDebugEnabled())
            log.debug("query: " + (JpqlQueryBuilder.printQuery(contextQuery.toString()))
